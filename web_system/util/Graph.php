...
class Graph {
	 ...
	 * 
	 * @param string $type
	 *        	Tipo de Grafo Especial: C- Circular, K- Completo
	 * @param int $quantity
	 *        	Quantidade de Vertices desse grafo
	 */
	 ...
	 * 
	 * @param string $vertexNameSearch
	 *        	Informação armazenada no vértice que está a procura
	 * @return Vertex Retorna o vértice encontrado, caso não tenha sido encontrado retorna null
	 */
	 ...
	 *        	Informação contida no vértice a ser deletado
	 * @return bool Retorna true caso o vértice tenha sido deletado, e false caso contrário
	 */
	 ...
	 *        	O vértice de origem da aresta a ser adicionada
	 * @param string $secondVertex
	 *        	O vértice de destino da aresta a ser adicionada
	 * @param float $edgeCost
	 *        	O peso da Aresta a ser adicionada
	 * @return bool Retorna se foi possível adicionar a aresta
	 */
	 ...
	 *        	O vértice de origem da aresta a ser removida
	 * @param Vertex $secondVertex
	 *        	O vértice de destino da aresta a ser removida
	 * @return bool
	 */
	 ...
	 * 
	 * @return int O número de vértices existentes no Grafo
	 */
	 ...
	 * 
	 * @return int O número de arestas existentes no Grafo
	 */
	 ...
	 * 
	 * @return ArrayList<Vertex> Vetor com todos os vértices do grafo
	 */
